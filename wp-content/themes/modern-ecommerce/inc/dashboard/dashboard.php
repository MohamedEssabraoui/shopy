...
function modern_ecommerce_guide() {
	...
	$theme = wp_get_theme( 'modern-ecommerce' ); ?>

	<div class="getting-started__header">
		<div class="col-md-10">
			<h2><?php echo esc_html( $theme ); ?></h2>
			<p><?php esc_html_e('Version: ', 'modern-ecommerce'); ?><?php echo esc_html($theme['Version']);?></p>
		</div>
		<div class="col-md-2">
			<div class="btn_box">
		...
		<div class="container">
			<div class="col-md-9">
				<div class="leftbox">
					...
					<p><?php esc_html_e('To step the Modern Ecommerce theme follow the below steps.','modern-ecommerce'); ?></p>
					...
					<a class="button-primary" href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=modern_ecommerce_middle_section') ); ?>" target="_blank"><?php esc_html_e('Add Services','modern-ecommerce'); ?></a>
			...
			<div class="col-md-3">
				<h3><?php esc_html_e('Premium Modern Ecommerce Theme','modern-ecommerce'); ?></h3>
				<img class="modern_ecommerce_img_responsive" style="width: 100%;" src="<?php echo esc_url( get_template_directory_uri() ); ?>/screenshot.png">
				<div class="pro-links">
					<hr>
			    	<a class="button-primary" href="<?php echo esc_url( MODERN_ECOMMERCE_LIVE_DEMO ); ?>" target="_blank"><?php esc_html_e('Live Demo', 'modern-ecommerce'); ?></a>
					<a class="button-primary" href="<?php echo esc_url( MODERN_ECOMMERCE_BUY_PRO ); ?>" target="_blank"><?php esc_html_e('Buy Now', 'modern-ecommerce'); ?></a>
					<a class="button-primary" href="<?php echo esc_url( MODERN_ECOMMERCE_PRO_DOC ); ?>" target="_blank"><?php esc_html_e('Documentation', 'modern-ecommerce'); ?></a>
					<hr>
				</div>
